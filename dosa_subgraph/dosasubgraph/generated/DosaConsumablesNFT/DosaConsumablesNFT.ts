...
export class DosaConsumablesNFT extends ethereum.SmartContract {
  static bind(address: Address): DosaConsumablesNFT {
    return new DosaConsumablesNFT("DosaConsumablesNFT", address);
  }
